...
public:
	...
	void Init(const char* szKeyName)
	{
		...
		static auto oInitKeyValues = (InitKeyValuesFn)(pattern::Scan(XOR("client.dll"), ("55 8B EC 51 33 C0 C7 45"))); // @xref: "OldParticleSystem_Destroy"
	...
	void LoadFromBuffer(char const* szResourceName, const char* szBuffer, void* szFileSystem = nullptr, const char* szPathID = nullptr, void* pfnEvaluateSymbolProc = nullptr)
	{
		...
		static auto oLoadFromBuffer = (LoadFromBufferFn)(pattern::Scan(XOR("client.dll"), ("55 8B EC 83 E4 F8 83 EC 34 53 8B 5D 0C 89"))); // @xref: "KeyValues::LoadFromBuffer(%s%s%s): Begin"
