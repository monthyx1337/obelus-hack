...
// note
// replaced for proper grabbing ways
// float_value =/= GetFloat() !!!
// they won't return the same exact results, for example, sv_maxunlag will return something different that would cause our lagcompensation/backtrack to fail
// also added new utlvector system 
...
{
    inline convar* clear;
    inline convar* toggleconsole;
    inline convar* update_rate;
    inline convar* max_update_rate;
    inline convar* interp;
    inline convar* interp_ratio;
    inline convar* min_interp_ratio;
    inline convar* max_interp_ratio;
    inline convar* max_unlag;
    inline convar* cl_cmdrate;
    inline convar* cl_lagcompensation;
    inline convar* mp_teammates_are_enemies;
    inline convar* cl_crosshair_sniper_width;
    inline convar* r_drawspecificstaticprop;
}
...
public:
    __forceinline const char* GetString() {
        return utilities::CallVirtual< const char* (__thiscall*)(decltype(this)) >(this, GETSTRING)(this);
    }

    __forceinline float GetFloat() {
        return utilities::CallVirtual< float(__thiscall*)(decltype(this)) >(this, GETFLOAT)(this);
    }

    __forceinline int GetInt() {
        return utilities::CallVirtual< int(__thiscall*)(decltype(this)) >(this, GETINT)(this);
    }

    __forceinline void SetValue(const char* value) {
        return utilities::CallVirtual< void(__thiscall*)(decltype(this), const char*) >(this, SETVALUE_SZ)(this, value);
    }

    __forceinline void SetValue(float value) {
        return utilities::CallVirtual< void(__thiscall*)(decltype(this), float) >(this, SETVALUE_FLOAT)(this, value);
    }

    __forceinline void SetValue(int value) {
        return utilities::CallVirtual< void(__thiscall*)(decltype(this), int) >(this, SETVALUE_INT)(this, value);
    }
...
{
public:
    mutable c_studio_hdr* m_pstudiohdr; //0x0000 
    mutable c_studio_hdr* m_pvmodel; //0x0004  // virtualmodel_t!!!!
    char				pad_unknown[0x4]; //0x0008 
    mutable CUtlVector<const c_studio_hdr*> m_pstudiohdrcache; //0x000C 
