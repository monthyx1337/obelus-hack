    ...
    if (first_begin_of_the_frame)
    {
        ...
        else
        {
            if (flags & ImGuiWindowFlags_NoScrollbar)
            {
                ...
                ImU32 bg_col = ImColor(12 / 255.f, 12 / 255.f, 12 / 255.f, g.Style.Alpha2);
                window->DrawList->AddRectFilled(window->Pos + ImVec2(0, window->TitleBarHeight()), window->Pos + window->Size, bg_col, window_rounding, (flags & ImGuiWindowFlags_NoTitleBar) ? ImDrawCornerFlags_All : ImDrawCornerFlags_Bot);

                window->DrawList->PushClipRect(window->Pos, window->Pos + window->Size, true);
                window->DrawList->PopClipRect();
                outline(window, 0, ImColor(0 / 255.f, 0 / 255.f, 0 / 255.f, g.Style.Alpha2));
                outline(window, 1, ImColor(48 / 255.f, 48 / 255.f, 48 / 255.f, g.Style.Alpha2));
                window->DrawList->AddText(window->Pos + ImVec2(6 + 4 + 2 + 65 + 14 - 2, 6 + 2), ImColor(180 / 255.f, 180 / 255.f, 180 / 255.f, g.Style.Alpha2), "spectators");
                window->DrawList->AddRect(window->Pos + ImVec2(6 + 5, 6 + 18), window->Pos + ImVec2(window->Size.x - 8 - 6 + 2, 8 + 18), ImColor(config.menu_color[0], config.menu_color[1], config.menu_color[2], g.Style.Alpha2));
                window->DrawList->AddRect(window->Pos + ImVec2(6 + 5, 7 + 18), window->Pos + ImVec2(window->Size.x - 8 - 6 + 2, 8 + 18), ImColor(0.f, 0.f, 0.f, ImClamp(58 / 255.f, 0.f, g.Style.Alpha2)));

                window->DrawList->AddRectFilled(window->Pos + ImVec2(6 + 5, 7 + 18 + 30 + 30 - 18 - 35), window->Pos + ImVec2(window->Size.x - 8 - 6 + 2, window->Size.y - 8 + 18 + 19 - 42), ImColor(0.051f, 0.051f, 0.051f, ImClamp(255 / 255.f, 0.f, g.Style.Alpha2)));
                window->DrawList->AddRect(window->Pos + ImVec2(6 + 5, 7 + 18 + 30 + 30 - 18 - 35), window->Pos + ImVec2(window->Size.x - 8 - 6 + 2, window->Size.y - 8 + 18 + 19 - 42), ImColor(0.f, 0.f, 0.f, ImClamp(255 / 255.f, 0.f, g.Style.Alpha2)));
                window->DrawList->AddRect(window->Pos + ImVec2(6 + 5 + 1, 7 + 18 + 30 + 30 - 18 + 1 - 35), window->Pos + ImVec2(window->Size.x - 8 - 6 + 2 - 1, window->Size.y - 8 + 18 + 19 - 1 - 42), ImColor(0.20f, 0.20f, 0.20f, ImClamp(255 / 255.f, 0.f, g.Style.Alpha2)));
            }
            // Window background
            if (!(flags & ImGuiWindowFlags_NoBackground))
            {
                if (!(flags & ImGuiWindowFlags_ChildWindow) && !(flags & ImGuiWindowFlags_Popup) && !(flags & ImGuiWindowFlags_Tooltip)) {
                    ...
                    if (flags & ImGuiWindowFlags_PlayerlistTab)
                    {
                        ImU32 bg_col = ImColor(12 / 255.f, 12 / 255.f, 12 / 255.f, g::StoredAlpha);
                        float alpha = 1.0f;
                        ...
                        outline(window, 0, ImColor(0 / 255.f, 0 / 255.f, 0 / 255.f, g::StoredAlpha));
                        outline(window, 1, ImColor(48 / 255.f, 48 / 255.f, 48 / 255.f, g::StoredAlpha));

                        std::string str(__DATE__);
                        window->DrawList->AddText(window->Pos + ImVec2(6 + 4 + 2, 6 + 2), ImColor(180 / 255.f, 180 / 255.f, 180 / 255.f, g::StoredAlpha), "confirmation");
                        window->DrawList->AddRect(window->Pos + ImVec2(6 + 5, 6 + 18), window->Pos + ImVec2(window->Size.x - 8 - 6 + 2, 8 + 18), ImColor(config.menu_color[0], config.menu_color[1], config.menu_color[2],  g::StoredAlpha));
                        window->DrawList->AddRect(window->Pos + ImVec2(6 + 5, 7 + 18), window->Pos + ImVec2(window->Size.x - 8 - 6 + 2, 8 + 18), ImColor(0.f, 0.f, 0.f, ImClamp(58 / 255.f, 0.f,  g::StoredAlpha)));

                        window->DrawList->AddRectFilled(window->Pos + ImVec2(6 + 5, 7 + 18 + 30 + 30 - 18 - 35), window->Pos + ImVec2(window->Size.x - 8 - 6 + 2, window->Size.y - 8 + 18 + 19 - 42), ImColor(0.051f, 0.051f, 0.051f, ImClamp(255 / 255.f, 0.f,  g::StoredAlpha)));
                        window->DrawList->AddRect(window->Pos + ImVec2(6 + 5, 7 + 18 + 30 + 30 - 18 - 35), window->Pos + ImVec2(window->Size.x - 8 - 6 + 2, window->Size.y - 8 + 18 + 19 - 42), ImColor(0.f, 0.f, 0.f, ImClamp(255 / 255.f, 0.f,  g::StoredAlpha)));
                        window->DrawList->AddRect(window->Pos + ImVec2(6 + 5 + 1, 7 + 18 + 30 + 30 - 18 + 1 - 35), window->Pos + ImVec2(window->Size.x - 8 - 6 + 2 - 1, window->Size.y - 8 + 18 + 19 - 1 - 42), ImColor(0.20f, 0.20f, 0.20f, ImClamp(255 / 255.f, 0.f,  g::StoredAlpha)));
                    }
                    else
                    {
                        ...
                        //window->DrawList->AddRectFilledMultiColor(window->Pos + ImVec2(6, 6), window->Pos + ImVec2(window->Size.x - 8, 8), ImColor(0 / 255.f, 0 / 255.f, 0 / 255.f, 0 / 255.f), ImColor(0 / 255.f, 0 / 255.f, 0 / 255.f, 0 / 255.f), ImColor(0 / 255.f, 0 / 255.f, 0 / 255.f, ImClamp(120.f / 255.f, 0.f, g.Style.Alpha)), ImColor(0 / 255.f, 0 / 255.f, 0 / 255.f, ImClamp(120.f / 255.f, 0.f, g.Style.Alpha)));
                       
                        std::string str(__DATE__);
                        window->DrawList->AddText(window->Pos + ImVec2(6 + 2 + 4 + 2 - 3, 6 + 2), ImColor(config.menu_color[0], config.menu_color[1], config.menu_color[2], g.Style.Alpha), "obelus");
                       // window->DrawList->AddText(window->Pos + ImVec2(6 + 2 + 4 + 2 + 31 + 4 - 10 - 15, 6 + 2), ImColor(config.menu_color[0], config.menu_color[1], config.menu_color[2], g.Style.Alpha), " hack");
                        window->DrawList->AddText(window->Pos + ImVec2(6 + 3 + 4 + 2 + 31 + 4 + 5 + 9 - 15 + 1 - 6, 6 + 2), ImColor(135 / 255.f, 135 / 255.f, 135 / 255.f, g.Style.Alpha), " | ");
                        window->DrawList->AddText(window->Pos + ImVec2(6 + 3 + 4 + 2 + 31 + 4 + 5 + 9 + 5 + 3 - 15 + 1 - 6, 6 + 2), ImColor(142 / 255.f, 142 / 255.f, 142 / 255.f, g.Style.Alpha), str.c_str());



                        window->DrawList->AddRect(window->Pos + ImVec2(6 + 5, 6 + 18), window->Pos + ImVec2(window->Size.x - 8 - 6 + 2, 8 + 18), ImColor(config.menu_color[0], config.menu_color[1], config.menu_color[2], g.Style.Alpha));
                   ...
                   // window->DrawList->AddRectFilled(window->Pos + ImVec2(6, 6), window->Pos + ImVec2(window->Size.x - 6, 2), ImColor(config.menu_color[0], config.menu_color[1], config.menu_color[2], g.Style.Alpha));
					//window->DrawList->AddRectFilled(window->Pos + ImVec2(6, 7), window->Pos + ImVec2(window->Size.x - 6, 2), ImColor(0.f, 0.f, 0.f, ImClamp(150 / 255.f, 0.f, g.Style.Alpha)));
				}
                else {
